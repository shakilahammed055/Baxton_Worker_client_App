...
import 'package:baxton/features/werknemer_flow/werknemer_home/set_price/views/set_price_task_details_screen.dart';
import 'package:baxton/features/werknemer_flow/werknemer_home/set_price/views/widget/set_price_task_card.dart';
      ...
      body: Obx(() {
        return ListView.builder(
          ...
          itemBuilder: (_, index) {
            ...
            return SetPriceTaskCard(
              setPriceTask: newAllSetPricesTasks,
              onSetPrice:
                  () => Get.to(
                    () => TaskDetailScreen(setPriceTasks: newAllSetPricesTasks),
                  ),
            );
          },
        );
