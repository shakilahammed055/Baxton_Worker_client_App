...
import 'package:baxton/features/werknemer_flow/authentication/views/signup_screen.dart';
...
class WLoginScreen extends StatelessWidget {
  WLoginScreen({super.key});
  WLoginScreenController wloginController = Get.put(WLoginScreenController());
