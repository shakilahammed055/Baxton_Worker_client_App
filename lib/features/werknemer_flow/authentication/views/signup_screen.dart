...
import 'package:baxton/features/werknemer_flow/authentication/controllers/signup_controller.dart';
...
class WSignupScreen extends StatelessWidget {
  WSignupScreen({super.key});
  WSignupController singupController = Get.put(WSignupController());
  @override
