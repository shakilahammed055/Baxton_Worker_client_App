...
import 'package:baxton/features/klant_flow/message_screen/widgets/custom_popup_menu.dart';
import 'package:baxton/features/klant_flow/message_screen/widgets/single_textfield.dart';
import 'package:baxton/features/klant_flow/profile_screen/controller/profile_controller.dart';
import 'package:emoji_picker_flutter/emoji_picker_flutter.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BerichtSinglePageChat extends StatelessWidget {
  final Map<String, dynamic> chat;

  BerichtSinglePageChat({super.key, required this.chat});
  final darkcontroller = Get.put(ProfileController());

  @override
  Widget build(BuildContext context) {
    bool isOnline = chat['isOnline'] == 'true';
    final controller = Get.put(SinglePageChatController());
